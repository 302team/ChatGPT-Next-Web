...
const de: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "Bitte besuchen Sie [GPT302](https://dash.gpt302.com), um Ihren eigenen Roboter zu erstellen (GPT302 befindet sich derzeit in der internen Testphase, melden Sie sich bitte zuerst bei Proxy302 an, um Zugriff zu erhalten)",
  },
  ChatItem: {
  ...
  Chat: {
    ...
    Input: (submitKey: string) => {
      ...
      return "Nachricht senden"; // inputHints + ", / zum Durchsuchen von Prompts";
    },
    Send: "Senden",
    Config: {
      Reset: "Reset to Default",
      SaveAs: "Save as Assistent",
    },
  },
  Export: {
  ...
  NewChat: {
    Return: "Return",
    Skip: "Skip",
    Title: "Pick a Assistent",
    SubTitle: "Chat with the Soul behind the Assistent",
    More: "Find More",
