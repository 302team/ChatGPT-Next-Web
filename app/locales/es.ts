...
const es: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      " Por favor, visita [GPT302](https://dash.gpt302.com) para crear tu propio robot (GPT302 está actualmente en fase de pruebas internas, por favor inicia sesión en Proxy302 primero para obtener acceso)",
  },
  ChatItem: {
  ...
  Chat: {
    ...
    Input: (submitKey: string) => {
      ...
      return "Enviar mensaje"; // inputHints;
    },
    Send: "Enviar",
    Config: {
  ...
  NewChat: {
    Return: "Return",
    Skip: "Skip",
    Title: "Pick a Asistente",
    SubTitle: "Chat with the Soul behind the Asistente",
    More: "Find More",
