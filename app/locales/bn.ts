...
const bn: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "[GPT302](https://dash.gpt302.com) এ যান এবং আপনার নিজের রোবট তৈরি করুন (বর্তমানে GPT302 অন্তর্নিহিত পরীক্ষায়, অনুমতি অ্যাক্সেস পাওয়ার জন্য প্রথমে Proxy302 লগইন করুন)",
  },
  Auth: {
    ...
    Input: "অ্যাক্সেস কোড",
    Remember: "অ্যাক্সেস কোড মনে রাখুন",
    ValidError: " অ্যাক্সেস কোড ভুল",
