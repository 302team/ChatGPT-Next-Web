...
const ru: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "Пожалуйста, посетите [GPT302](https://dash.gpt302.com), чтобы создать своего собственного робота (GPT302 в настоящее время находится внутреннем тестировании, пожалуйста, сначала войдите в Proxy302, чтобы получить доступ)",
  },
  ChatItem: {
